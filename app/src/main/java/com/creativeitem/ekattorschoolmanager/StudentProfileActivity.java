...
public class StudentProfileActivity extends ActionBarActivity implements ServerManager.ServerResponseHandler{
    ...
    public void initValues() {
        ...
        ImageView studentImageView = (ImageView)findViewById(R.id.student_imageView);
        ...
        SharedPreferences preferences = getApplicationContext().getSharedPreferences("EkattorSchoolManagerPrefs", 0);
        authKey = preferences.getString("AUTHKEY", "");
        loginType = preferences.getString("LOGINTYPE", "");
        TextView studentNameText = (TextView)findViewById(R.id.studentName_textView);
        ...
        profileListView = (ListView)findViewById(R.id.student_profile_listView);
        ...
        marks = new HashMap<>();
        marksListView = (ExpandableListView)findViewById(R.id.student_marks_listView);
    ...
    public void profileButtonAction(View view) {
        ...
        Button marks = (Button)findViewById(R.id.marks_button);
        profile.setBackgroundColor(getResources().getColor(R.color.appColor));
    ...
    public void marksButtonClicked(View view) {
        Button profile = (Button)findViewById(R.id.profile_button);
        Button marks = (Button)findViewById(R.id.marks_button);
        marks.setBackgroundColor(getResources().getColor(R.color.appColor));
