...
//        Spinner classSpinner = (Spinner)findViewById(R.id.classList_spinner);
//        classSpinner.setVisibility(View.INVISIBLE);
        ...
        classListCustomSpinner.setVisibility(View.INVISIBLE);
...
//            });
            ...
            classListCustomSpinner.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SubjectsActivity.this);
                    LayoutInflater inflater = SubjectsActivity.this.getLayoutInflater();
        ...
        ListView subjectListView = (ListView)findViewById(R.id.subjects_listView);
    ...
    public void requestFinished(String response, int requestTag) {
        ...
        try {
            if (requestTag == GET_CLASS_LIST_REQUEST) {
                ...
                selectionListAdapter = new SelectionListAdapter(this, classNames);
//                Spinner classSpinner = (Spinner)findViewById(R.id.classList_spinner);
//                classSpinner.setVisibility(View.VISIBLE);
//                classSpinner.setAdapter(selectionListAdapter);

                LinearLayout classListCustomSpinner = (LinearLayout)findViewById(R.id.class_list_custom_spinner);
                classListCustomSpinner.setVisibility(View.VISIBLE);
