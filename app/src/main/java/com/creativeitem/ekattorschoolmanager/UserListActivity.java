...
public class UserListActivity extends ActionBarActivity implements ServerManager.ServerResponseHandler {
    ...
    public void initValues() {
        ...
        TextView userTypeText = (TextView)findViewById(R.id.userType_textView);
        TextView classNameText = (TextView)findViewById(R.id.className_textView);
        ImageView userIcon = (ImageView)findViewById(R.id.user_icon);
        userTypeText.setText(userType);
        if (userType.equals("Students"))
            userIcon.setImageResource(R.drawable.ic_006_student);
        if (userType.equals("Teachers"))
            userIcon.setImageResource(R.drawable.ic_005_presentation);
        if (userType.equals("Parents"))
            userIcon.setImageResource(R.drawable.ic_004_family);
        if (userType.equals("Students"))
            classNameText.setText(className);
        else
            classNameText.setText("");
        SearchView userSearchView = (SearchView)findViewById(R.id.user_searchView);
