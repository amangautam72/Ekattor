...
public class StudentExamMarksActivity extends ActionBarActivity implements ServerManager.ServerResponseHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_exam_marks);
    ...
    public void initValues() {
        ...
        marks = new HashMap<>();
        ExpandableListView studentMarkListView = (ExpandableListView)findViewById(R.id.student_exam_marks_listView);
