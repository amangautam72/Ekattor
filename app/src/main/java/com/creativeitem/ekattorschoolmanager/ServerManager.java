...
/**
 * Created by creativeitem on 12/17/15.
 * server manager class. performs all server requests asynchronously
 */
public class ServerManager {
    // server address. change this to your server address
    final private String SERVER_ADDRESS = "http://nexusjobz.com/school/";

    public String sendMessageApi = SERVER_ADDRESS + "index.php?mobile/" + "send_new_message";
    ...
    //fetch notifications
    public void getNotices(String authKey, String loginType, int requestTag){
        String url = SERVER_ADDRESS + "index.php?mobile/" + "get_notices";
        HashMap<String, String> params = new HashMap<>();
    ...
    public void attendanceUpdate(String authKey, String loginType, JSONArray jsonArray, int requestTag){
        String url = SERVER_ADDRESS + "index.php?mobile/" + "attendance_update";
        HashMap<String, String> params = new HashMap<>();
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
        params.put("student_json", String.valueOf(jsonArray));
        AsyncHttpPost requestSender = new AsyncHttpPost(url, params, requestTag);
        requestSender.execute();
    }
    ...
    public void getClassList(String authKey, String loginType, int requestTag) {
        ...
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
        System.out.println("AUTH & UserType : "+authKey+","+loginType);
        AsyncHttpPost requestSender = new AsyncHttpPost(url, params, requestTag);
        requestSender.execute();
    }
    // fetch child list
    ...
    public void getAttendance(String authKey, String loginType, int day, int month, int year, String classId,String sectionId, int requestTag) {
    ...
    // fetch exam marks
    public void getMarks(String authKey, String loginType, String examId, String classId, String subjectId, String sectionId, int requestTag) {
    ...
    public void getStudyMaterial(String authKey,String loginType,String Id, int requestTag){
        String url = SERVER_ADDRESS + "index.php?mobile/" + "get_study_material";
        HashMap<String, String> params = new HashMap<>();
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
        if (loginType.equals("student")||loginType.equals("teacher")){
    ...
    public void getAcademicSyllabus(String authKey,String loginType,String Id, int requestTag){
        String url = SERVER_ADDRESS + "index.php?mobile/" + "get_academic_syllabus";
        HashMap<String, String> params = new HashMap<>();
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
        if (loginType.equals("student")||loginType.equals("teacher")){
    ...
    public void getMessageUserList(String authKey, String loginType, int requestTag) {
        String url = SERVER_ADDRESS + "index.php?mobile/" + "get_message_userlist";
        HashMap<String, String> params = new HashMap<>();
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
        AsyncHttpPost requestSender = new AsyncHttpPost(url, params, requestTag);
    ...
    public void getAllMessageById(String authKey, String loginType,String loginId, int requestTag) {
        String url = SERVER_ADDRESS + "index.php?mobile/" + "get_all_message_by_id";
        HashMap<String, String> params = new HashMap<>();
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
    ...
    public void sendNewMessage(String authKey, String loginType,String loginId,String filePath,String messageBody,String recieverId, int requestTag) {
        String url = SERVER_ADDRESS + "index.php?mobile/" + "send_new_message";
        HashMap<String, String> params = new HashMap<>();
        params.put("authentication_key", authKey);
        params.put("user_type", loginType);
        params.put("login_id",loginId);
        ...
        params.put("reciever",loginType+"-"+recieverId);
        AsyncHttpPost requestSender = new AsyncHttpPost(url, params, requestTag);
        requestSender.execute();
    }
